...
fn main() {
    ...
    // println!("Day1 test1 p1: {}", d2_solver.solve_p1());
    // println!("Day1 test1 p2: {}", d2_solver.solve_p2());


    // d2_solver.extract_info(String::from("/home/alexis/advent_of_code/data/d2/input.txt"));
    // println!("Day1 p1: {}", d2_solver.solve_p1());
    // println!("Day1 p2: {}", d2_solver.solve_p2());
    ...
    println!("Day1 test1 p1: {}", d3_solver.solve_p1());
    println!("Day1 test1 p2: {}", d3_solver.solve_p2());


    d3_solver.extract_info(String::from("/home/alexis/advent_of_code/data/d3/input.txt"));
    println!("Day1 p1: {}", d3_solver.solve_p1());
    println!("Day1 p2: {}", d3_solver.solve_p2());
}
